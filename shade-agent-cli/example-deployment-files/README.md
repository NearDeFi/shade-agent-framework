...
| [example-11.yaml](./example-11.yaml) | **Self-hosted dstack server.** First-time TEE deployment to your own TDX box over SSH instead of Phala Cloud, using `deploy_to_dstack`. |
