...
> [!TIP]
> Visit the [yield and resume section](https://docs.near.org/smart-contracts/anatomy/yield-resume) of the docs for a deeper look into this pattern.
