...
| `test_register_agent_new_agent_requires_storage_deposit_integration` | First `register_agent` with no attached deposit fails; with the exact `0.00486 NEAR` storage cost succeeds; `get_agent` shows a valid agent. |
